...
public class GarcomView extends JFrame {
    ...
    private void initComponents() {
        ...
        JButton btnACaminho = new JButton("Marcar A CAMINHO");
        btnACaminho.addActionListener(e -> atualizarStatus(StatusPedido.A_CAMINHO));

        JButton btnEntregue = new JButton("Marcar ENTREGUE");
        btnEntregue.addActionListener(e -> atualizarStatus(StatusPedido.ENTREGUE));
    ...
    private void carregarPedidos() {
        model.setRowCount(0);
        List<Pedido> pedidos = controller.listarPendentesGarcom();
